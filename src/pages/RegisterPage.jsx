  ...
  return (
    ...
    <div className="flex flex-1">
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-5 h-5"
            />
            <label htmlFor="isAdmin" className="text-black text-lg font-['Kameron']">
              Sou administrador
            </label>
          </div>
        ...
        <span className="text-white text-xl font-bold font-['Kameron']">FAÇA </span>
        <span className="text-black text-xl font-bold font-['Kameron']">LOGIN</span>
      </Link>
            <img
              src="seta.png"
              alt="Seta"
